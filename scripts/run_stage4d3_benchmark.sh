#!/usr/bin/env bash
# Stage 4D.3: Post-Bootstrap Multi-Topology Re-evaluation
# 5 topologies × 2 variants × 3 runs = 30 runs
set -euo pipefail
...
ESCAPE_PARAMS="${CONFIG_DIR}/stage4d3/forced_escape.yaml"
OUT_ROOT="${HOME}/stage4d3_benchmark"

TOPOLOGIES=(l_turn_tunnel dead_end_branch branching_tunnel_y t_junction_tunnel straight_tunnel)
VARIANTS=(stage3d_baseline stage4d3_forced_escape)
RUN_IDS=(01 02 03)
